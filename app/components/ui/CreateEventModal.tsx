    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative h-full w-full max-w-3xl overflow-y-auto rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800 dark:text-white">
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute right-4 top-4 text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"
        >
          <svg
          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-4">
              {additionalFiles.map((file, index) => (
                <div
                  key={index}
                  className="w-30 relative h-36 overflow-hidden rounded-lg bg-gray-200"
                >
                  <img
                    src={file.url}
                    alt={file.name}
