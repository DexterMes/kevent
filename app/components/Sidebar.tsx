...
//     <aside
//       id="sidebar"
//       className="fixed left-0 top-14 z-40 h-[calc(100vh-3rem)] w-64 -translate-x-full bg-gray-50 transition-transform dark:bg-gray-800 sm:translate-x-0"
//       aria-label="Sidebar"
//     >
...
//                 viewBox="0 0 20 20"
//               >
//                 <path d="M7 2h10v16H7V2zm5 8v4h-2v-4H7l5-5 5 5h-3z" />
//               </svg>
...
const Sidebar = ({
  ...
  return (
    <aside
      id="sidebar"
      className="z-40 h-full w-64 bg-gray-50 dark:bg-gray-800 sm:translate-x-0"
      aria-label="Sidebar"
    >
